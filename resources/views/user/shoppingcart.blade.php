...
@section('content')
    ...
    <div id="content" class="right">
		...
		<table width="700" border="0" cellpadding="5" cellspacing="0">
            ...
            <tr bgcolor="#41581B">
                <td><img src="{{ asset('images/product/01.jpg')}}" alt="flower image 1" /></td> 
                <td>Ut eu feugiat</td> 
                <td align="center"><input name="quantity1" type="text" id="quantity1" value="1" size="6" maxlength="2" /> </td>
                <td align="right">$240</td> 
                <td align="right">$240</td>
                <td align="center"> <a href="#"><img src="{{ asset('images/remove.png')}}" alt="remove" /><br />Remove</a> </td>
            </tr>
      <tr bgcolor="#41581B">
                <td><img src="{{ asset('images/product/02.jpg')}}" alt="flower image 2" /> </td>
...
<tr bgcolor="#41581B">
                <td colspan="3">Have you modified item quantities? Please <a href="/shoppingcart"><strong>Update</strong></a> the Cart.&nbsp;&nbsp;</td>
