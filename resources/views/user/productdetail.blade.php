...
@section('content')
    ...
    <div id="content" class="right">
        ...
        <div class="content_half left">
        	<a  rel="lightbox" href="{{ asset('images/product/image_01_l.jpg')}}"><img src="{{ asset('images/product/image_01.jpg')}}" width="330px" height="200px" alt="yellow flowers" /></a>
        </div>
            <div class="content_half right">
                ...
                <a href="/shoppingcart" class="button">Add to Cart</a>
			</div>
