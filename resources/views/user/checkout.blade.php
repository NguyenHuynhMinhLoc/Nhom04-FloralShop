...
@section('content')
    ...
    <div id="content" class="right">
		...
		<h3>BILLING DETAILS</h3>
            ...
            <p><a href="#"><img src="{{ asset('images/1311260370_paypal-straight.png')}}" alt="paypal" align="middle" /></a>&nbsp;(recommended if you have a PayPal account. Fastest way to complete your order.)</p>
            <p><a href="#"><img src="{{ asset('images/flagship.jpg')}}" alt="Flagship" align="middle" /></a>&nbsp;(free shipping for orders above $500)</p>
            <div class="blank_box">
